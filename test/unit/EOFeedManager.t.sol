...
contract EOFeedManagerTests is Test, Utils {
    ...
    function test_updatePriceFeed() public {
        ...
        assertEq(feedAdapter.sourceBlockNumber, checkpoint.blockNumber);
    }
    ...
    function test_updatePriceFeeds() public {
        ...
        assertEq(feeds[0].sourceBlockNumber, checkpoint.blockNumber);
        assertEq(feeds[1].sourceBlockNumber, checkpoint.blockNumber);
    }
